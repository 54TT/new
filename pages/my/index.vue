<template>
	<view class="myContent">
		...
		<uni-popup ref="logoutDialog" type="dialog" class="logoutBoxPopup">
			<uni-popup-dialog type="info" cancelText="取消" confirmText="确定" content="确认退出登录吗？" @confirm="dialogConfirm"></uni-popup-dialog>
		</uni-popup>
	</view>
	<Tarbar />
</template>
...
const informationList = [
	{ img: MyMaterial, text: '我的资料', key: 'Material', his: '/pages/my/components/account' },
	{ img: MyTeam, text: '我的团队', key: 'Team', his: '/pages/my/components/team' },
	{ img: MyFriend, text: '分享好友', key: 'Friend', his: '/pages/my/components/invite' },
